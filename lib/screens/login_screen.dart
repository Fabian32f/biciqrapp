...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // Controladores de formulario, lógica de inicio de sesión, etc.
  @override
    ...
    child: Center(
        child: Column(
          children: <Widget>[
            ...
            // Campos de formulario, botón de inicio de sesión, etc.
            Form(
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled: true, // Rellena el campo de color
                        fillColor: Colors.black26, // Ejemplo de color blanco
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          border: OutlineInputBorder(
                          borderSide: BorderSide(
                            color: Colors.blue, // Ejemplo de color azul
                            width: 2.0,
                          ),
                        ),
